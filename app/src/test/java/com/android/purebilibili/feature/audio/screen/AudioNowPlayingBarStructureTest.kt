...
class AudioNowPlayingBarStructureTest {
    ...
    fun nowPlayingBarUsesBottomBarCapsuleGlassAndCoverSpin() {
        ...
        assertTrue(source.contains("supplementalContentProgress"))
    ...
    fun appNavigationHostsNowPlayingBarBesideBottomBarBackdrop() {
        ...
        assertTrue(overlay.contains("entrySource = VideoDetailEntrySource.AUDIO_NOW_PLAYING_BAR"))
        assertTrue(overlay.contains("videoDetailMorphEnabled = !audioNowPlayingBarOpensAudioMode"))
